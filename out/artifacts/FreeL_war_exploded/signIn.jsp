<%@ page import="servlets.SignInServlet" %><%--
...
<header class="masthead text-center text-white " style="background-image: url('assets/img/background.jpg');">
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form method="post">
                <p style="color: red"><%= request.getParameter("er") != null ? request.getParameter("er") : ""%></p>
                <div class="form-group"><label for="email" style="color: rgb(74,83,118)">Email</label><input class="form-control item" type="email" placeholder="Введите почту" id="email" name="email" value="<%= request.getParameter("email") != null ? request.getParameter("email") : ""%>"></div>
                ...
                <div class="form-group">
                    <div class="form-check"><input class="form-check-input" type="checkbox" id="checkbox"><label class="form-check-label" for="checkbox" style="color: rgb(74,83,118)">Remember me</label></div>
                </div><button class="btn btn-primary btn-block" type="submit" style="background: rgb(74,83,118);">Войти</button><a href="/signUp" style="color: rgb(74,83,118);margin-top: 200px;">Еще нет аккаунта? Зарегистрируйтесь!</a></form>
        </div>
    </section></header>
